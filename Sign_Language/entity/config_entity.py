...
taining_pipeline_config : TrainingPipelineConfig = TrainingPipelineConfig()

@dataclass
class DataIngestionConfig:
    data_ingestion_dir : str = os.path.join(taining_pipeline_config.artifacts_dir,DATA_INGESTION_DIR_NAME)
...
class DataValidationConfig:
    data_validation_dir : str = os.path.join(
        taining_pipeline_config.artifacts_dir,DATA_VALIDATION_DIR_NAME
    )
...
class ModelTrainerConfig:
    model_trainer_dir : str = os.path.join(taining_pipeline_config.artifacts_dir,MODEL_TRAINER_DIR_NAME)
